...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @Akramsalah     |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @Akramsalah       |') end
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/YEMEN/Run.lua','./YEMEN/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @Akramsalah     |') end
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/YEMEN/locks.lua','./YEMEN/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @Akramsalah   |') end
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/YEMEN/Script.lua','./YEMEN/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @Akramsalah  |') end
...
usernn = data.username_ or "Akramsalah"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "Akramsalah"
end
Name = Name:gsub('[[][]]','')
...
message = message ..i.. '-l ['..info.username..'](t.me/Akramsalah) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/Akramsalah) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/Akramsalah) l » (`' ..v.. '`) \n'
end
end
end
...
function chat_list(msg)
    local list = redis:smembers(js..'group:ids')
    message = '-قائمه المجموعات :\n\n'
    for k,v in pairs(list) do 
    local info = redis:get(js..'group:name'..v)
    if info then 
