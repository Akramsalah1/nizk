...
return sendMsg(msg.chat_id_,msg.id_,"♔ المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "Akramsalah"))
end
end
...
elseif UserID == "313055885" then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقييد *مطورين Akram* ؛") 
...
return'✶⁞ اصدار سورس Akram : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'❦ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس Akram يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس :  ",url="t.me/Akramsalah"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: ](t.me/Akramsalah)',nil,inline,msg.id_)
return false
end
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل *مطورين Akram* ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
NameUser = Hyper_Link_Name(data)
if UserID == 313055885  then 
return sendMsg(ChatID,MsgID,"✶⁞ لا يمكنك حظر *مطورين البوت* ؛") 
end
if redis:sismember(js..'bannedpv',UserID) then 
...
if FwdUser == 313055885 then 
return sendMsg(arg.ChatID,arg.id_,"- لا يمكنك حظر *مطورين Akram* ؛") 
end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ عذرا هذا الحساب محظور من سيرفرات حماية Akram ") end
...
elseif  msg.text=="خواطر" or msg.text== "الخواطر" or msg.text== "خواطر" then
  sendMsg(msg.chat_id_,msg.id_,https.request('https://3jsc.l.time4vps.cloud/5oater.php'))

elseif not msg.SudoUser and Text=="بوت" or Text == "البوت" or Text == "بوت" then
sendMsg(msg.chat_id_,msg.id_,bott[math.random(#bott)])

elseif Text== "مطور السورس"  then return sendMsg(msg.chat_id_,msg.id_,"[akram](T.ME/akramsalah)")
...
if msg.type == "pv" then 
  if  msg.text=="خواطر" or msg.text== "الخواطر" or msg.text== "خواطر" then
    return sendMsg(msg.chat_id_,msg.id_,https.request('https://3jsc.l.time4vps.cloud/5oater.php'))end
